...
//How to use:
//1. Create a material with the Custom/ReflectiveSurface shader applied
//2. Add the material to a meshrenderer
//3. Add this script to the meshrenderer gameObject
...
namespace RGSK
{
    ...
    public class ReflectiveSurface : MonoBehaviour
    {
        ...
        [SerializeField] ReflectionQuality reflectionQuality;
        [SerializeField] float m_ClipPlaneOffset = 0.02f;
