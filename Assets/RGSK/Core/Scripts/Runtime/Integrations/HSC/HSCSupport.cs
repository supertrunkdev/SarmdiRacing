...
{
#if HSC_SUPPORT
    public class HSCSupport : RGSKEntityComponent, IVehicle
    {
        ...
        void Update()
        {
            _controller.VerticalPosition(ThrottleInput);
            _controller.HorizontalPosition(SteerInput);
        }
