...
//Thanks to the Unity Open Project #1 for providing this code!
namespace RGSK.Editor
{
    ...
    /// </summary>
    class ScriptableObjectBrowserWindow : EditorWindow
    {
        ...
        [MenuItem("Window/RGSK/Tools/Scriptable Object Browser", false, 2601)]
        public static void ShowWindow()
        {
            GetWindow<ScriptableObjectBrowserWindow>("Scriptable Objects");
        }
