    ...
    public class SceneReferencePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.BeginProperty(position, GUIContent.none, property);
            {
                ...
                property.isExpanded = true; //EditorGUI.Foldout(new Rect(position.x, position.y, position.width, lineHeight), property.isExpanded, label);
                ...
                if (property.isExpanded)
                {
                    ...
                    var sceneAsset = EditorGUI.ObjectField(position,
                    sceneAssetProperty.objectReferenceValue, typeof(SceneAsset), false);

                    var changedSceneAsset = EditorGUI.EndChangeCheck();
                    EditorGUI.showMixedValue = restoreShowMixedValue;

                    if (!property.serializedObject.isEditingMultipleObjects || (property.serializedObject.isEditingMultipleObjects && changedSceneAsset))
        ...
        private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
        {
            ...
            {
                iconContent = CustomEditorStyles.redIconContent;
            ...
            {
                iconContent = CustomEditorStyles.greenIconContent;
            ...
            {
                iconContent = CustomEditorStyles.yellowIconContent;
                labelContent.text = "Build Index: " + buildScene.buildIndex;
            ...
            using (new EditorGUI.DisabledScope(readOnly))
            {
                ...
                if (buildScene.buildIndex == -1)
                {
                    ...
                    if (DrawUtils.ButtonHelper(buttonRect, "Add...", "Add", EditorStyles.miniButtonLeft, tooltipMsg))
